...
class Config:
    ...
    PHYSICS_LOSS_WEIGHT = 0.01 # Weight for the physics-informed loss original was 0.01, last working was 0.1
    PHYSICS_LOSS_BETA = 1.0    # Beta for physics loss smoothing
    RESULTS_DIR = 'results'
